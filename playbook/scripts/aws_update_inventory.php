...
<?PHP
###########################################################################################################
###> New x php -> scripts/aws_update_inventory.php  -> Initial creation user => eric => 2024-03-01_04:06:20 ###
###########################################################################################################
...
//$PHP_INC= exec('echo $PHP_INC',$o);
//include($__dir__."/dep_func.php");
include("dep_func.php");
...
*/
function get_aws_asg_instances($dep_vars['asg_name']){
//	$cmd="aws'; 
	
}
$asg_ins=get_aws_asg_instances($dep_vars);
...
$yaml_inventory_file='/home/eric/wrk/dep-1/01-rwi-k8s/playbook/inventory/inventory.yml';  ###> Original inventory yaml
